...
export const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-16 lg:py-24 bg-base-200">
        ...
        >
          ...
          <div className="flex w-full justify-between">
            ...
            >
              ...
              <div className="">
                <h3 className="text-xl font-semibold mt-8 mb-4">Mes Reseaux</h3>
                <div className="flex gap-4">
                  ...
                  <a
                    href="https://wa.me/message/TKVG4X4UOBRUP1"
                    target="_blank"
                    className="p-3 rounded-full bg-base-content/10 hover:bg-primary/10 text-base-content hover:text-primary transition-colors"
                  >
                    <svg
